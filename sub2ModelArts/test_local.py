...
if __name__=="__main__":
    # checkpoint=torch.load('./tf_efficientnet_b5_ns_456_best.pth',map_location=torch.device('cpu'))
    # checkpoint1=torch.load('./tf_efficientnet_b6_ns_best.pth',map_location=torch.device('cpu'))
    s=garbage_classify_service(model_name='tf_efficientnet_b4_ns', model_path='./tf_efficientnet_b5_ns_456_best.pth')
